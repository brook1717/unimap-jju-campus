      ...
      <section className="space-y-2">
        {LINKS.map(({ icon: Icon, label, value, href }) => (
          <a
            ...
            "
          >
            <Icon className="h-[18px] w-[18px] text-brand-primary flex-shrink-0" />
            ...
            <ExternalLink className="h-3.5 w-3.5 text-slate-300 dark:text-slate-600 flex-shrink-0" aria-hidden="true" />
          </a>
        ))}
      </section>
    </div>
